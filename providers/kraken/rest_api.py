"""
Kraken REST API client for fetching klines/OHLCV data.
...
class KrakenRestAPI(BaseExchangeRestAPI):
    """
    Kraken REST API client for authoritative klines/OHLCV data.

    Uses ccxt library for unified interface with Kraken API.
    """
    ...
    def __init__(self):
        ...
        logger.info("KrakenRestAPI initialized")
    ...
    async def fetch_klines(
        ...
        """Fetch klines from Kraken REST API"""
    ...
    async def close(self) -> None:
        ...
        logger.info("KrakenRestAPI closed")
